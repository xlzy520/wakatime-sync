module.exports = (function(e, t) {
  ...
  function __webpack_require__(t) {
    ...
    e[t].call(a.exports, a, a.exports, __webpack_require__)
    a.l = true
    return a.exports
  }
  ...
  0: function(e, t, r) {
    ...
    function authenticationBeforeRequest(e, t) {
      if (typeof e.auth === 'string') {
        t.headers.authorization = p(e.auth)
        return
      }
      if (e.auth.username) {
  ...
  2: function(e, t) {
    ...
    async function auth(e) {
      ...
      const d = p.test(e)
      const s = t ? 'app' : i ? 'installation' : d ? 'user-to-server' : 'oauth'
  ...
  41: function(e, t) {
    ...
    function normalizePaginatedListResponse(e, t, r) {
      const p = t.replace(e.request.endpoint.DEFAULTS.baseUrl, '')
      const i = a.find(e => e.test(p))
      if (!i) return
      const d = r.data.incomplete_results
      const s = r.data.repository_selection
      ...
      if (typeof d !== 'undefined') {
        r.data.incomplete_results = d
      }
      if (typeof s !== 'undefined') {
        r.data.repository_selection = s
      }
      r.data.total_count = n
      Object.defineProperty(r.data, o, {
        get() {
          e.log.warn(
            `[@octokit/paginate-rest] "response.data.${o}" is deprecated for "GET ${p}". Get the results directly from "response.data"`
          )
          return Array.from(u)
        }
      })
      ...
      return {
        [Symbol.asyncIterator]: () => ({
          next() {
            ...
            return e.request({ method: p, url: d, headers: i }).then(t => {
              normalizePaginatedListResponse(e, d, t)
              d = ((t.headers.link || '').match(/<([^>]+)>;\s*rel="next"/) || [])[1]
              return { value: t }
            })
          }
        })
    ...
    function gather(e, t, r, a) {
      return r.next().then(p => {
        ...
        t = t.concat(a ? a(p.value, done) : p.value.data)
        if (i) {
          return t
        }
  ...
  64: function(e, t, r) {
    ...
    function isDate(e) {
      return p.call(e) === '[object Date]'
    }
    function isFile(e) {
      return p.call(e) === '[object File]'
    }
    function isBlob(e) {
      return p.call(e) === '[object Blob]'
    }
    ...
    function extend(e, t, r) {
      forEach(t, function assignValue(t, p) {
  ...
  78: function(e) {
    ...
    function hookChildProcess(e, r) {
      ...
      e.emit = function(t, p) {
        if (t === 'exit') {
          const t = verifyENOENT(p, r, 'spawn')
          if (t) {
  ...
  85: function(e, t, r) {
    ...
    if (typeof a.getSystemErrorName === 'function') {
      ...
      try {
        p = process.binding('uv')
        if (typeof p.errname !== 'function') {
  ...
  97: function(e, t, r) {
    ...
    if (!p(a)) {
      ...
      if (a.__signal_exit_emitter__) {
        o = a.__signal_exit_emitter__
      } else {
        o = a.__signal_exit_emitter__ = new n()
        o.count = 0
        o.emitted = {}
      }
      if (!o.infinite) {
      ...
      var u = function unload() {
        if (!c || !p(global.process)) {
          return
        }
        c = false
        d.forEach(function(e) {
          try {
            a.removeListener(e, l[e])
          } catch (e) {}
        })
        a.emit = y
        a.reallyExit = h
      ...
      var f = function processReallyExit(e) {
        ...
        a.exitCode = e || 0
        m('exit', a.exitCode, null)
        m('afterexit', a.exitCode, null)
        h.call(a, a.exitCode)
      }
      var y = a.emit
      var v = function processEmit(e, t) {
        if (e === 'exit' && p(global.process)) {
          if (t !== undefined) {
            a.exitCode = t
          }
  ...
  98: function(e) {
    ...
    e.exports = e => {
      ...
      const p = []
      const i = Math.max(a.length, t.length)
      for (let r = 0; r < i; r++) {
        let i = null
        if (a[r] !== undefined) {
          i = a[r]
  ...
  103: function(e, t, r) {
    ...
    e.exports = a.isStandardBrowserEnv()
      ? (function standardBrowserEnv() {
          return {
            write: function write(e, t, r, p, i, d) {
              var s = []
  ...
  109: function(e, t, r) {
    ...
    e.exports = function transformData(e, t, r) {
      var i = this || p
      a.forEach(r, function transform(r) {
        e = r.call(i, e, t)
      })
      return e
    }
  ...
  128: function(e, t, r) {
    ...
    function bindApi(e, t, r) {
      ...
      ;['before', 'error', 'after', 'wrap'].forEach(function(a) {
        var i = r ? [t, a, r] : [t, a]
        e[a] = e.api[a] = s(p, null).apply(null, i)
      })
    }
  ...
  149: function(e) {
    ...
    var f = g || h || Function('return this')()
    ...
    var j = D ? D.prototype : undefined,
      O = j ? j.toString : undefined
    function Hash(e) {
      var t = -1,
        r = e ? e.length : 0
      this.clear()
    ...
    function hashHas(e) {
      var t = this.__data__
      return C ? t[e] !== undefined : T.call(t, e)
    }
    function hashSet(e, t) {
      var a = this.__data__
      a[e] = C && t === undefined ? r : t
      return this
    }
    ...
    function mapCacheClear() {
      this.__data__ = { hash: new Hash(), map: new (N || ListCache)(), string: new Hash() }
    }
    ...
    var A = memoize(function(e) {
      ...
      e.replace(u, function(e, r, a, p) {
        t.push(a ? p.replace(l, '$1') : r || e)
      })
      return t
    })
    function toKey(e) {
    ...
    function memoize(e, r) {
      ...
      a.cache = new (memoize.Cache || MapCache)()
      return a
    }
  ...
  153: function(e, t, r) {
    ...
    const { Deprecation: a } = r(670)
    const p = r(137)
    const i = p((e, t) => e.warn(t))
    const d = r(869)
    const s = r(901)
    const n = r(411)
  ...
  168: function(e, t, r) {
    ...
    t.implementation = class URLImpl {
      constructor(e) {
        ...
        const i = a.basicURLParse(t, { baseURL: p })
        if (i === 'failure') {
  ...
  186: function(e) {
    ...
    function addHook(e, t, r, a) {
      ...
      e.registry[r].push({ hook: a, orig: p })
    }
  },
  189: function(e, t, r) {
    e.exports = factory
    ...
    function getMessageContent(e, t) {
      if (t.length > 0) {
        ...
        return `## Wakatime Daily Report\nTotal: ${r.text}\n${getItemContent(
          'Projects',
          e
        )}\n${getItemContent('Languages', a)}\n${getItemContent('Editors', i)}\n${getItemContent(
          'Categories',
          p
        )}\n`
      }
  ...
  217: function(e, t, r) {
    e.exports = authenticationPlugin
    const { createTokenAuth: a } = r(2)
    const { Deprecation: p } = r(670)
    const i = r(137)
    const d = r(0)
    const s = r(544)
    const n = r(135)
    ...
    function authenticationPlugin(e, t) {
      ...
      const r = typeof t.auth === 'string' && /^basic/.test(o(t.auth))
      ...
      i(e.log, new p('[@octokit/rest] ' + l))
      e.auth = () => Promise.resolve({ type: 'deprecated', message: l })
      n(t.auth)
      const c = { octokit: e, auth: t.auth }
      e.hook.before('request', d.bind(null, c))
      e.hook.error('request', s.bind(null, c))
    }
  },
  220: function(e, t, r) {
  ...
  246: function(e, t, r) {
    ...
    function fetchWrapper(e) {
      ...
      return n(
        ...
        .then(async i => {
          ...
          if (e.method === 'HEAD') {
            ...
            throw new s.RequestError(i.statusText, a, {
              response: { url: p, status: a, headers: r, data: undefined },
              request: e
            })
          }
          if (a === 304) {
            throw new s.RequestError('Not modified', a, {
              response: { url: p, status: a, headers: r, data: await getResponseData(i) },
              request: e
            })
          }
          if (a >= 400) {
            const t = await getResponseData(i)
            const d = new s.RequestError(toErrorMessage(t), a, {
              response: { url: p, status: a, headers: r, data: t },
              request: e
            })
            throw d
          }
        ...
        .then(e => {
          return { status: a, url: p, headers: r, data: e }
        })
        .catch(t => {
    ...
    function withDefaults(e, t) {
      ...
      const a = function(e, t) {
        ...
        Object.assign(p, { endpoint: r, defaults: withDefaults.bind(null, r) })
        return a.request.hook(p, a)
      }
      return Object.assign(a, { endpoint: r, defaults: withDefaults.bind(null, r) })
    }
    const o = withDefaults(a.endpoint, {
      headers: { 'user-agent': `octokit-request.js/${n} ${p.getUserAgent()}` }
    })
    t.request = o
  },
  265: function(e, t, r) {
    ...
    var s = {
      ...
      transformRequest: [
        function transformRequest(e, t) {
          ...
          if (a.isObject(e) || (t && t['Content-Type'] === 'application/json')) {
      ...
      transformResponse: [
        function transformResponse(e) {
          ...
          var p = t && t.forcedJSONParsing
          var d = !r && this.responseType === 'json'
          if (d || (p && a.isString(e) && e.length)) {
            try {
              return JSON.parse(e)
            } catch (e) {
              if (d) {
    ...
    e.exports = function xhrAdapter(e) {
      return new Promise(function dispatchXhrRequest(t, r) {
        ...
        if (e.auth) {
          ...
          var f = e.auth.password ? unescape(encodeURIComponent(e.auth.password)) : ''
          l.Authorization = 'Basic ' + btoa(h + ':' + f)
        }
        var y = s(e.baseURL, e.url)
        g.open(e.method.toUpperCase(), d(y, e.params, e.paramsSerializer), true)
        g.timeout = e.timeout
        function onloadend() {
          if (!g) {
            return
          }
          var a = 'getAllResponseHeaders' in g ? n(g.getAllResponseHeaders()) : null
          var i = !c || c === 'text' || c === 'json' ? g.responseText : g.response
          var d = {
            data: i,
            status: g.status,
        ...
        g.onabort = function handleAbort() {
          ...
          r(u('Request aborted', e, 'ECONNABORTED', g))
          g = null
        }
        g.onerror = function handleError() {
          r(u('Network Error', e, null, g))
          g = null
        }
        ...
        if (a.isStandardBrowserEnv()) {
          var v =
            (e.withCredentials || o(y)) && e.xsrfCookieName ? i.read(e.xsrfCookieName) : undefined
          if (v) {
            l[e.xsrfHeaderName] = v
          }
        }
        if ('setRequestHeader' in g) {
          a.forEach(l, function setRequestHeader(e, t) {
            if (typeof m === 'undefined' && t.toLowerCase() === 'content-type') {
              delete l[t]
            } else {
        ...
        if (!a.isUndefined(e.withCredentials)) {
  ...
  309: function(e) {
    ...
    function hashHas(e) {
      var t = this.__data__
      return O ? t[e] !== undefined : S.call(t, e)
    }
    function hashSet(e, t) {
      var a = this.__data__
      a[e] = O && t === undefined ? r : t
      return this
    }
    Hash.prototype.clear = hashClear
    Hash.prototype['delete'] = hashDelete
    ...
    function assignValue(e, t, r) {
      var a = e[t]
      if (!(S.call(e, t) && eq(a, r)) || (r === undefined && !(t in e))) {
        e[t] = r
      }
    }
    function assocIndexOf(e, t) {
    ...
    function baseSet(e, t, r, a) {
      ...
      while (s != null && ++p < i) {
        ...
        if (p != d) {
          var u = s[n]
          o = a ? a(u, n, s) : undefined
          if (o === undefined) {
            o = isObject(u) ? u : isIndex(t[p + 1]) ? [] : {}
          }
        }
        assignValue(s, n, o)
        s = s[n]
    ...
    var V = memoize(function(e) {
      e = toString(e)
      var t = []
      if (u.test(e)) {
        t.push('')
      }
      e.replace(m, function(e, r, a, p) {
        t.push(a ? p.replace(c, '$1') : r || e)
      })
      return t
    })
    function toKey(e) {
    ...
    function isSymbol(e) {
      return typeof e == 'symbol' || (isObjectLike(e) && D.call(e) == s)
    }
    function toString(e) {
      return e == null ? '' : baseToString(e)
    }
  ...
  314: function(e, t, r) {
    ...
    e.exports = function parseHeaders(e) {
      ...
      a.forEach(e.split('\n'), function parser(e) {
        d = e.indexOf(':')
        r = a.trim(e.substr(0, d)).toLowerCase()
        i = a.trim(e.substr(d + 1))
        if (r) {
          if (t[r] && p.indexOf(r) >= 0) {
            return
          }
          if (r === 'set-cookie') {
        ...
        w = {
          ...
          z: function(e) {
            var t = -e.utcOffset(),
              ...
              a = Math.floor(r / 60),
              p = r % 60
            return (t <= 0 ? '+' : '-') + v(a, 2, '0') + ':' + v(p, 2, '0')
          },
          m: function t(e, r) {
            if (e.date() < r.date()) return -t(r, e)
            var a = 12 * (r.year() - e.year()) + (r.month() - e.month()),
              p = e.clone().add(a, u),
              i = r - p < 0,
              d = e.clone().add(a + (i ? -1 : 1), u)
            return +(-(a + (r - p) / (i ? p - d : d - p)) || 0)
          },
          a: function(e) {
          ...
          p: function(e) {
            return (
              { M: u, y: l, w: o, d: n, D: c, h: s, m: d, s: i, ms: p, Q: m }[e] ||
              String(e || '')
                .toLowerCase()
                .replace(/s$/, '')
            )
      ...
      var q = function(e) {
        ...
        T = function t(e, r, a) {
          ...
          if ('string' == typeof e) {
            ...
            b[i] && (p = i), r && ((b[i] = r), (p = i))
            var d = e.split('-')
            if (!p && d.length > 1) return t(d[0])
          } else {
            var s = e.name
            ;(b[s] = e), (p = s)
          }
          return !a && p && (_ = p), p || (!a && _)
        },
        E = function(e, t) {
          ...
          return (
              ...
              ;(this.$d = (function(e) {
                ...
                if ('string' == typeof t && !/Z$/i.test(t)) {
                  ...
                  if (a) {
                    ...
                    return r
                      ? new Date(Date.UTC(a[1], p, a[3] || 1, a[4] || 0, a[5] || 0, a[6] || 0, i))
                      : new Date(a[1], p, a[3] || 1, a[4] || 0, a[5] || 0, a[6] || 0, i)
                  }
                }
                return new Date(t)
              })(e)),
            ...
            (t.startOf = function(e, t) {
              var r = this,
                ...
                p = S.p(e),
                m = function(e, t) {
                  var p = S.w(r.$u ? Date.UTC(r.$y, t, e) : new Date(r.$y, t, e), r)
                  return a ? p : p.endOf(n)
                },
                g = function(e, t) {
                  return S.w(
                    r
                      .toDate()
                      [e].apply(r.toDate('s'), (a ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(t)),
                    r
                  )
                },
                h = this.$W,
              ...
              switch (p) {
                ...
                case u:
                  return a ? m(1, f) : m(0, f + 1)
                case o:
                  var w = this.$locale().weekStart || 0,
                    _ = (h < w ? h + 7 : h) - w
                  return m(a ? y - _ : y + (6 - _), f)
                case n:
                case c:
                  return g(v + 'Hours', 0)
                case s:
            ...
            (t.$set = function(e, t) {
              var r,
                ...
                (r[p] = o + 'Milliseconds'),
                r)[a],
                g = a === n ? this.$D + (t - this.$W) : t
              if (a === u || a === l) {
                var h = this.clone().set(c, 1)
                h.$d[m](g), h.init(), (this.$d = h.set(c, Math.min(this.$D, h.daysInMonth())).$d)
              } else m && this.$d[m](g)
            ...
            (t.add = function(t, p) {
              ...
              var g = S.p(p),
                h = function(e) {
                  var r = E(c)
                  return S.w(r.date(r.date() + Math.round(e * t)), c)
                }
              if (g === u) return this.set(u, this.$M + t)
              if (g === l) return this.set(l, this.$y + t)
              if (g === n) return h(1)
              if (g === o) return h(7)
              var f = ((m = {}), (m[d] = r), (m[s] = a), (m[i] = e), m)[g] || 1,
                y = this.$d.getTime() + t * f
              return S.w(y, this)
            }),
            ...
            (t.format = function(e) {
              ...
              var a = e || 'YYYY-MM-DDTHH:mm:ssZ',
                ...
                o = r.months,
                u = function(e, r, p, i) {
                  return (e && (e[r] || e(t, a))) || p[r].substr(0, i)
                },
                m = function(e) {
                ...
                c = {
                  ...
                  M: s + 1,
                  MM: S.s(s + 1, 2, '0'),
                  MMM: u(r.monthsShort, s, o, 3),
                  MMMM: u(o, s),
                  D: this.$D,
                  DD: S.s(this.$D, 2, '0'),
                  d: String(this.$W),
                  dd: u(r.weekdaysMin, this.$W, n, 2),
                  ddd: u(r.weekdaysShort, this.$W, n, 3),
                  dddd: n[this.$W],
                  H: String(i),
                  HH: S.s(i, 2, '0'),
                  h: m(1),
              ...
              return a.replace(f, function(e, t) {
                return t || c[e] || p.replace(':', '')
              })
            }),
            (t.utcOffset = function() {
              return 15 * -Math.round(this.$d.getTimezoneOffset() / 15)
            }),
            (t.diff = function(t, p, c) {
              var g,
                h = S.p(p),
                f = E(t),
                y = (f.utcOffset() - this.utcOffset()) * r,
                v = this - f,
                w = S.m(this, f)
              return (
                (w =
  ...
  325: function(e, t, r) {
    ...
    e.exports = function mergeConfig(e, t) {
      ...
      function getMergedValue(e, t) {
        if (a.isPlainObject(e) && a.isPlainObject(t)) {
          return a.merge(e, t)
      ...
      function mergeDeepProperties(p) {
        if (!a.isUndefined(t[p])) {
          r[p] = getMergedValue(e[p], t[p])
        } else if (!a.isUndefined(e[p])) {
          r[p] = getMergedValue(undefined, e[p])
        }
      }
      a.forEach(p, function valueFromConfig2(e) {
        if (!a.isUndefined(t[e])) {
          r[e] = getMergedValue(undefined, t[e])
        }
      })
      a.forEach(i, mergeDeepProperties)
      a.forEach(d, function defaultToConfig2(p) {
        if (!a.isUndefined(t[p])) {
          r[p] = getMergedValue(undefined, t[p])
        } else if (!a.isUndefined(e[p])) {
          r[p] = getMergedValue(undefined, e[p])
        }
      })
      a.forEach(s, function merge(a) {
        if (a in t) {
          r[a] = getMergedValue(e[a], t[a])
        } else if (a in e) {
          r[a] = getMergedValue(undefined, e[a])
        }
      })
      var n = p
        .concat(i)
      ...
      a.forEach(o, mergeDeepProperties)
      return r
    }
  },
  326: function(e, t, r) {
    ...
    function checkPathExt(e, t) {
      ...
      for (var a = 0; a < r.length; a++) {
        var p = r[a].toLowerCase()
        if (p && e.substr(-p.length).toLowerCase() === p) {
          return true
        }
      }
      return false
    ...
    function isexe(e, t, r) {
      a.stat(e, function(a, p) {
        r(a, a ? false : checkStat(p, e, t))
      })
    }
    function sync(e, t) {
  ...
  354: function(e) {
    'use strict'
    e.exports = function enhanceError(e, t, r, a, p) {
      e.config = t
      if (r) {
        e.code = r
      }
  ...
  359: function(e, t, r) {
    const { requestLog: a } = r(873)
    const { restEndpointMethods: p } = r(964)
    const i = r(961)
    const d = [r(217), r(153), a, r(54), p, r(146), r(852)]
    const s = i.plugin(d)
    ...
    const n = Object.assign(DeprecatedOctokit, { Octokit: s })
  ...
  393: function(e, t, r) {
    ...
    var o = function(e) {
      if (!s) return false
      if (!i) return false
      return (e instanceof (i.ReadStream || d) || e instanceof (i.WriteStream || d)) && n(e.close)
    }
    var u = function(e) {
    ...
    var m = function(e, t, r, i) {
      ...
      p(e, { readable: t, writable: r }, function(e) {
        if (e) return i(e)
        s = true
        i()
      })
    ...
    var g = function() {
      ...
      var r
      var a = e.map(function(p, i) {
        var d = i < e.length - 1
        var s = i > 0
        return m(p, d, s, function(e) {
          if (!r) r = e
          if (e) a.forEach(l)
          if (d) return
          a.forEach(l)
  ...
  411: function(e, t, r) {
    ...
    const { RequestError: a } = r(613)
    function authenticationRequestError(e, t, r) {
      if (!t.headers) throw t
      const p = /required/.test(t.headers['x-github-otp'] || '')
      if (t.status !== 401 || !p) {
        throw t
      }
      if (t.status === 401 && p && t.request && t.request.headers['x-github-otp']) {
  ...
  413: function(e, t, r) {
    ...
    e.exports = function dispatchRequest(e) {
      ...
      e.headers = e.headers || {}
      e.data = p.call(e, e.data, e.headers, e.transformRequest)
      ...
      return t(e).then(
        function onAdapterResolution(t) {
          throwIfCancellationRequested(e)
          t.data = p.call(e, t.data, t.headers, e.transformResponse)
          return t
        },
        function onAdapterRejection(t) {
          if (!i(t)) {
            throwIfCancellationRequested(e)
            if (t && t.response) {
              t.response.data = p.call(e, t.response.data, t.response.headers, e.transformResponse)
            }
          }
  ...
  431: function(e, t, r) {
    ...
    var i = r(605)
    var d = r(211)
    var s = r(794).Writable
    var n = r(357)
    var o = r(813)
    var u = ['abort', 'aborted', 'connect', 'error', 'socket', 'timeout']
    var m = Object.create(null)
    u.forEach(function(e) {
      m[e] = function(t, r, a) {
        this._redirectable.emit(e, t, r, a)
      }
    })
    var l = createErrorType('ERR_FR_REDIRECTION_FAILURE', 'Redirected request failed')
    var c = createErrorType('ERR_FR_TOO_MANY_REDIRECTS', 'Maximum number of redirects exceeded')
    ...
    RedirectableRequest.prototype._performRequest = function() {
      ...
      var p = (this._currentRequest = t.request(this._options, this._onNativeResponse))
        ...
        ;(function writeNext(e) {
          if (p === s._currentRequest) {
            if (e) {
              ...
              var t = n[d++]
              if (!p.finished) {
                p.write(t.data, t.encoding, writeNext)
              }
            } else if (s._ended) {
              p.end()
            }
    ...
    RedirectableRequest.prototype._processResponse = function(e) {
      ...
      var p = removeMatchingHeaders(/^host$/i, this._options.headers)
      var i = a.parse(this._currentUrl)
      var d = p || i.host
      var s = /^\w+:/.test(r) ? this._currentUrl : a.format(Object.assign(i, { host: d }))
      var n
      try {
        n = a.resolve(s, r)
      } catch (e) {
      ...
      if (
        ...
        (u.host !== d && !isSubdomain(u.host, d))
      ) {
        removeMatchingHeaders(/^(?:authorization|cookie)$/i, this._options.headers)
      }
      if (typeof this._options.beforeRedirect === 'function') {
        var m = { headers: e.headers }
        try {
          this._options.beforeRedirect.call(null, this._options, m)
        } catch (e) {
          this.emit('error', e)
          return
        }
    ...
    function wrap(e) {
      ...
      Object.keys(e).forEach(function(i) {
        var d = i + ':'
        var s = (r[d] = e[i])
        var u = (t[i] = Object.create(s))
        function request(e, i, s) {
          if (typeof e === 'string') {
            var u = e
            try {
              e = urlToOptions(new p(u))
            } catch (t) {
              e = a.parse(u)
            }
          } else if (p && e instanceof p) {
            e = urlToOptions(e)
          } else {
            s = i
            i = e
          ...
          i.nativeProtocols = r
          n.equal(i.protocol, d, 'protocol mismatch')
          o('options', i)
          return new RedirectableRequest(i, s)
        }
        function get(e, t, r) {
          var a = u.request(e, t, r)
          a.end()
          return a
        }
  ...
  457: function(e, t, r) {
    ...
    function parseHost(e, t) {
      ...
      const a = p.toASCII(r, false, p.PROCESSING_OPTIONS.NONTRANSITIONAL, false)
      if (a === null) {
        return d
      }
    ...
    function URLStateMachine(e, t, r, p, i) {
      this.pointer = 0
      this.input = e
      this.base = t || null
      ...
      if (e === 47 || e === 92) {
        ...
        if (isNaN(e)) {
          ...
          if (
            ...
            (this.input.length - this.pointer - 1 >= 2 && !o.has(this.input[this.pointer + 2]))
          ) {
            this.url.host = this.base.host
            this.url.path = this.base.path.slice()
  ...
  486: function(e, t, r) {
    ...
    Axios.prototype.getUri = function getUri(e) {
      e = s(this.defaults, e)
      return p(e.url, e.params, e.paramsSerializer).replace(/^\?/, '')
    }
    ...
    a.forEach(['post', 'put', 'patch'], function forEachMethodWithData(e) {
      Axios.prototype[e] = function(t, r, a) {
        return this.request(s(a || {}, { method: e, url: t, data: r }))
      }
    })
    e.exports = Axios
  },
  491: function(e, t, r) {
    ...
    function config(e) {
      let t = p.resolve(process.cwd(), '.env')
      let r = 'utf8'
      let i = false
      if (e) {
        if (e.path != null) {
      ...
      try {
        const e = parse(a.readFileSync(t, { encoding: r }), { debug: i })
        Object.keys(e).forEach(function(t) {
  ...
  522: function(e, t, r) {
    ...
    function parseOptions(e, t, r) {
      ...
      const m = `octokit.js/${d.version} ${p()}`
      i.headers['user-agent'] = [u, m].filter(Boolean).join(' ')
  ...
  540: function(e, t, r) {
    ...
    const p = r(919)
    e.exports = e => {
      e = Object.assign({ cwd: process.cwd(), path: process.env[p()] }, e)
      let t
  ...
  545: function(e, t, r) {
    ...
    function createInstance(e) {
      var t = new i(e)
      var r = p(i.prototype.request, t)
      a.extend(r, i.prototype, t)
      a.extend(r, t)
      return r
    }
  ...
  550: function(e, t, r) {
    ...
    e.exports = function normalizeHeaderName(e, t) {
      a.forEach(e, function processHeader(r, a) {
  ...
  558: function(e, t, r) {
    ...
    e.exports = e => {
      ...
      n.getBufferedValue = () => {
        ...
        return p ? Buffer.concat(s, d) : s.join('')
      }
  ...
  597: function(e, t) {
    ...
    SemVer.prototype.comparePre = function(e) {
      ...
      do {
        ...
        var p = e.prerelease[t]
        r('prerelease compare', t, a, p)
    ...
    function replaceTilde(e, t) {
      var a = t.loose ? d[x] : d[R]
      return e.replace(a, function(t, a, p, i, d) {
        r('tilde', e, t, a, p, i, d)
        var s
        if (isX(a)) {
          s = ''
    ...
    function replaceXRange(e, t) {
      e = e.trim()
      var a = t.loose ? d[j] : d[C]
      return e.replace(a, function(t, a, p, i, d, s) {
        r('xRange', e, t, a, p, i, d, s)
        var n = isX(p)
        var o = n || isX(i)
        var u = o || isX(d)
        var m = u
    ...
    function replaceStars(e, t) {
      r('replaceStars', e, t)
      return e.trim().replace(d[K], '')
    }
    function hyphenReplace(e, t, r, a, p, i, d, s, n, o, u, m, l) {
      if (isX(r)) {
        t = ''
      } else if (isX(a)) {
        t = '>=' + r + '.0.0'
    ...
    function outside(e, t, r, a) {
      ...
      for (var o = 0; o < t.set.length; ++o) {
        ...
        u.forEach(function(e) {
          ...
          m = m || e
          l = l || e
          if (p(e.semver, m.semver, a)) {
            m = e
          } else if (d(e.semver, l.semver, a)) {
            l = e
          }
        })
        if (m.operator === s || m.operator === n) {
          return false
        }
  ...
  613: function(e, t, r) {
    ...
    var a = r(670)
    var p = _interopDefault(r(137))
    const i = p(e => console.warn(e))
    class RequestError extends Error {
      constructor(e, t, r) {
        ...
        const p = Object.assign({}, r.request)
        if (r.request.headers.authorization) {
          p.headers = Object.assign({}, r.request.headers, {
  ...
  654: function(e, t, r) {
    ...
    var s = function(e, t, r) {
      ...
      var m = t.writable || (t.writable !== false && e.writable)
      var l = false
      var c = function() {
        if (!e.writable) g()
      }
      ...
      var w = function() {
        if (l) return
        if (u && !(o && o.ended && !o.destroyed)) return r.call(e, new Error('premature close'))
        if (m && !(n && n.ended && !n.destroyed)) return r.call(e, new Error('premature close'))
      }
      var _ = function() {
        e.req.on('finish', g)
      }
  ...
  683: function(e, t, r) {
    ...
    e.exports = function httpAdapter(e) {
      return new Promise(function dispatchHttpRequest(t, r) {
        ...
        var w = e.data
        var _ = e.headers
        if ('User-Agent' in _ || 'user-agent' in _) {
          if (!_['User-Agent'] && !_['user-agent']) {
            delete _['User-Agent']
            delete _['user-agent']
          }
        } else {
          _['User-Agent'] = 'axios/' + c.version
        }
        if (w && !a.isStream(w)) {
          if (Buffer.isBuffer(w)) {
          } else if (a.isArrayBuffer(w)) {
            w = Buffer.from(new Uint8Array(w))
          } else if (a.isString(w)) {
        ...
        var j = f.test(D)
        var O = j ? e.httpsAgent : e.httpAgent
        var A = {
          path: d(S.path, e.params, e.paramsSerializer).replace(/^\?/, ''),
        ...
        var P = e.proxy
        if (!P && P !== false) {
          var V = D.slice(0, -1) + '_proxy'
          var R = process.env[V] || process.env[V.toUpperCase()]
          if (R) {
            var x = m.parse(R)
            var L = process.env.no_proxy || process.env.NO_PROXY
            var U = true
            if (L) {
              var I = L.split(',').map(function trim(e) {
                return e.trim()
              })
              U = !I.some(function proxyMatch(e) {
                if (!e) {
                  return false
                }
                if (e === '*') {
                ...
                if (e[0] === '.' && S.hostname.substr(S.hostname.length - e.length) === e) {
                  return true
                }
                return S.hostname === e
              })
            ...
            if (U) {
              P = { host: x.hostname, port: x.port, protocol: x.protocol }
              if (x.auth) {
                var G = x.auth.split(':')
                P.auth = { username: G[0], password: G[1] }
              }
            }
          }
        }
        if (P) {
          ...
          setProxy(A, P, D + '//' + S.hostname + (S.port ? ':' + S.port : '') + A.path)
        }
        var B
        var F = j && (P ? f.test(P.protocol) : true)
        if (e.transport) {
          B = e.transport
        ...
        var M = B.request(A, function handleResponse(t) {
          if (M.aborted) return
          var r = t
          var i = t.req || M
          if (t.statusCode !== 204 && i.method !== 'HEAD' && e.decompress !== false) {
          ...
          if (e.responseType === 'stream') {
            ...
            r.on('data', function handleStreamData(t) {
              s.push(t)
              n += t.length
              if (e.maxContentLength > -1 && n > e.maxContentLength) {
                r.destroy()
                v(g('maxContentLength size of ' + e.maxContentLength + ' exceeded', e, null, i))
              }
            })
        ...
        M.on('error', function handleRequestError(t) {
          if (M.aborted && t.code !== 'ERR_FR_TOO_MANY_REDIRECTS') return
          v(h(t, e, null, M))
        })
        if (e.timeout) {
          var $ = parseInt(e.timeout, 10)
          if (isNaN($)) {
            v(g('error trying to parse `config.timeout` to int', e, 'ERR_PARSE_TIMEOUT', M))
            return
          }
          M.setTimeout($, function handleRequestTimeout() {
            M.abort()
            v(
              g(
  ...
  709: function(e) {
    ...
    function createNumberConversion(e, t) {
      ...
      const p = t.moduloBitLength ? Math.pow(2, t.moduloBitLength) : Math.pow(2, e)
  ...
  721: function(e, t, r) {
    'use strict'
    var a = r(354)
    e.exports = function createError(e, t, r, p, i) {
      var d = new Error(e)
      return a(d, t, r, p, i)
    }
  },
  722: function(e, t, r) {
    ...
    function handleArgs(e, t, r) {
      ...
      if (r.__winShell === true) {
        delete r.__winShell
        p = { command: e, args: t, options: r, file: e, original: { cmd: e, args: t } }
      } else {
        p = i._parse(e, t, r)
      }
      r = Object.assign(
        {
          ...
          stripEof: true,
          preferLocal: true,
          localDir: p.options.cwd || process.cwd(),
          encoding: 'utf8',
          reject: true,
          cleanup: true
        },
      ...
      if (process.platform === 'win32' && a.basename(p.command) === 'cmd.exe') {
        p.args.unshift('/q')
      }
      return { cmd: p.command, args: p.args, opts: r, parsed: p }
    }
    ...
    function getStream(e, t, { encoding: r, buffer: a, maxBuffer: p }) {
      if (!e[t]) {
        return null
      }
      let i
      if (!a) {
        ...
        i = o(e[t], { encoding: r, maxBuffer: p })
      } else {
        i = o.buffer(e[t], { maxBuffer: p })
      }
      return i.catch(e => {
        e.stream = t
    ...
    function makeError(e, t) {
      ...
      if (!p) {
        ...
        p = new Error(`Command failed: ${n}${e}`)
        p.code = i < 0 ? l(i) : i
      }
      p.stdout = r
      p.stderr = a
    ...
    e.exports = (e, t, r) => {
      ...
      const { encoding: d, buffer: s, maxBuffer: n } = a.opts
      const o = joinCmd(e, t)
      let l
      try {
        l = p.spawn(a.cmd, a.args, a.opts)
      } catch (e) {
        return Promise.reject(e)
      }
      let c
        ...
        u(
          Promise.all([
            ...
            if (t.error || t.code !== 0 || t.signal !== null) {
              const e = makeError(t, { joinedCmd: o, parsed: a, timedOut: h })
    ...
    e.exports.sync = (e, t, r) => {
      ...
      const d = p.spawnSync(a.cmd, a.args, a.opts)
      d.code = d.status
      if (d.error || d.status !== 0 || d.signal !== null) {
        const e = makeError(d, { joinedCmd: i, parsed: a })
        if (!a.opts.reject) {
          return e
        }
        throw e
      ...
      return {
        stdout: handleOutput(a.opts, d.stdout),
        stderr: handleOutput(a.opts, d.stderr),
        code: 0,
        failed: false,
        signal: null,
        cmd: i,
  ...
  744: function(e, t, r) {
    ...
    e.exports = function settle(e, t, r) {
      var p = r.config.validateStatus
      if (!r.status || !p || p(r.status)) {
        e(r)
      } else {
  ...
  760: function(e, t, r) {
    ...
    ;['object', 'boolean', 'number', 'function', 'string', 'symbol'].forEach(function(e, t) {
      p[e] = function validator(r) {
        return typeof r === e || 'a' + (t < 1 ? 'n ' : ' ') + e
      }
    })
    var i = {}
    var d = a.version.split('.')
    ...
    p.transitional = function transitional(e, t, r) {
      var p = t && isOlderVersion(t)
      function formatMessage(e, t) {
        return (
          '[Axios v' + a.version + "] Transitional option '" + e + "'" + t + (r ? '. ' + r : '')
        )
      }
      return function(r, a, d) {
        if (e === false) {
          throw new Error(formatMessage(a, ' has been removed in ' + t))
        }
        if (p && !i[a]) {
          i[a] = true
          console.warn(
    ...
    function assertOptions(e, t, r) {
      ...
      while (p-- > 0) {
        ...
        if (d) {
          var s = e[i]
          var n = s === undefined || d(s, i, e)
          if (n !== true) {
            throw new TypeError('option ' + i + ' must be ' + n)
          }
          continue
        }
        if (r !== true) {
    ...
    e.exports = { isOlderVersion: isOlderVersion, assertOptions: assertOptions, validators: p }
  },
  761: function(e) {
  ...
  769: function(e, t, r) {
      ...
      for (var s = 0; s < d; ++s) {
        ...
        switch (o[1]) {
          ...
          case 'ignored':
            break
          case 'mapped':
            p += String.fromCodePoint.apply(String, o[2])
            break
          case 'deviation':
            if (r === i.TRANSITIONAL) {
              p += String.fromCodePoint.apply(String, o[2])
    ...
    function validateLabel(e, t) {
      ...
      var p = countSymbols(e)
      for (var d = 0; d < p; ++d) {
        var n = findStatus(e.codePointAt(d))
        if (
          (processing === i.TRANSITIONAL && n[1] !== 'valid') ||
          (processing === i.NONTRANSITIONAL && n[1] !== 'valid' && n[1] !== 'deviation')
        ) {
          r = true
          break
        }
    ...
    function processing(e, t, r) {
      ...
      var p = a.string.split('.')
      for (var i = 0; i < p.length; ++i) {
        try {
          var d = validateLabel(p[i])
          p[i] = d.label
          a.error = a.error || d.error
        } catch (e) {
          a.error = true
        }
      }
      return { string: p.join('.'), error: a.error }
    }
    e.exports.toASCII = function(e, t, r, p) {
  ...
  778: function(e) {
    ...
    var u = n || o || Function('return this')()
    ...
    function mapCacheClear() {
      this.__data__ = { hash: new Hash(), map: new (b || ListCache)(), string: new Hash() }
    }
    function mapCacheDelete(e) {
      return getMapData(this, e)['delete'](e)
    }
    ...
    var E = !(q && 1 / setToArray(new q([, -0]))[1] == a)
      ? noop
      : function(e) {
          return new q(e)
        }
    ...
    function validate(e, t) {
      ...
      Object.keys(r).forEach(e => {
        ...
        if (/\./.test(e)) {
          ...
          o = p(t, n)
          u = n === 'headers' || (typeof o === 'object' && o !== null)
        }
        const l = m ? (p(t, n) || []).map(t => t[e.split(/\./).pop()]) : [p(t, e)]
        l.forEach((r, p) => {
          const n = typeof r !== 'undefined'
          const o = r === null
          const l = m ? e.replace(/\[\]/, `[${p}]`) : e
          if (!d.required && !n) {
            return
          }
          if (!u) {
          ...
          if (d.required && !n) {
            throw new a(`Empty value for parameter '${l}': ${JSON.stringify(r)}`, 400, {
              request: t
            })
          }
          if (s === 'integer') {
  ...
  807: function(e, t, r) {
    ...
    function getPathInfo(e, t) {
      var r = t.colon || i
      var p = t.path || process.env.PATH || ''
      var d = ['']
      p = p.split(r)
      var s = ''
      if (a) {
        p.unshift(process.cwd())
        s = t.pathExt || process.env.PATHEXT || '.EXE;.CMD;.BAT;.COM'
        d = s.split(r)
        if (e.indexOf('.') !== -1 && d[0] !== '') d.unshift('')
      }
      if (e.match(/\//) || (a && e.match(/\\/))) p = ['']
      return { env: p, ext: d, extExe: s }
    }
    function which(e, t, r) {
      ...
      ;(function F(a, u) {
        ...
        var m = i[a]
        if (m.charAt(0) === '"' && m.slice(-1) === '"') m = m.slice(1, -1)
        var l = p.join(m, e)
        if (!m && /^\.[\\\/]/.test(e)) {
          l = e.slice(0, 2) + l
        }
        ;(function E(e, p) {
          if (e === p) return F(a + 1, u)
          var i = s[e]
          d(l + i, { pathExt: n }, function(a, d) {
            if (!a && d) {
              if (t.all) o.push(l + i)
  ...
  852: function(e, t, r) {
    ...
    function paginationMethodsPlugin(e) {
      e.getFirstPage = r(438).bind(null, e)
      e.getLastPage = r(503).bind(null, e)
      e.getNextPage = r(265).bind(null, e)
      e.getPreviousPage = r(220).bind(null, e)
      e.hasFirstPage = r(987)
      e.hasLastPage = r(808)
      e.hasNextPage = r(601)
      e.hasPreviousPage = r(353)
    }
  },
  861: function(e, t, r) {
    e.exports = isexe
    ...
    function checkMode(e, t) {
      ...
      var u = s | n
      var m = r & o || (r & n && p === d) || (r & s && a === i) || (r & u && i === 0)
      return m
    }
  },
  869: function(e, t, r) {
  ...
  873: function(e, t) {
    ...
    function requestLog(e) {
      e.hook.wrap('request', (t, r) => {
        ...
        const a = Date.now()
        const p = e.request.endpoint.parse(r)
        const i = p.url.replace(r.baseUrl, '')
        return t(r)
          .then(t => {
            e.log.info(`${p.method} ${i} - ${t.status} in ${Date.now() - a}ms`)
            return t
          })
          .catch(t => {
            e.log.info(`${p.method} ${i} - ${t.status} in ${Date.now() - a}ms`)
  ...
  875: function(e, t, r) {
    'use strict'
    t.URL = r(118).interface
    t.serializeURL = r(457).serializeURL
    t.serializeURLOrigin = r(457).serializeURLOrigin
    t.basicURLParse = r(457).basicURLParse
    t.setTheUsername = r(457).setTheUsername
    t.setThePassword = r(457).setThePassword
    t.serializeHost = r(457).serializeHost
    t.serializeInteger = r(457).serializeInteger
    t.parseURL = r(457).parseURL
  },
  877: function(e, p, i) {
    'use strict'
    function t(e) {
      ...
      var r,
        ...
        p = (function(e, t) {
          ...
          var r,
            ...
            p = {},
            i = Object.keys(e)
          for (a = 0; a < i.length; a++) (r = i[a]), 0 <= t.indexOf(r) || (p[r] = e[r])
          return p
        })(e, t)
    ...
    var s,
      ...
      l = function(e) {
        var t = e.dateRange,
          ...
          p = e.branchNames,
          i = void 0 === p ? [] : p
        return { start: t.startDate, end: t.endDate, project: a, branches: i.join(',') }
      },
      c = function() {
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
          ...
          i = e.projectName,
          d = void 0 === i ? null : i
        return { timeout: r, writes_only: p, project: d }
      },
      g = function(e) {
        var t = e.date,
          r = e.projectName,
          a = void 0 === r ? null : r,
          p = e.branchNames
        return { date: t, project: a, branches: (void 0 === p ? [] : p).join(',') }
      },
      h = function() {
        var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
          t = e.authorUsername,
          ...
          (function(e, t, a) {
            ...
            },
            {
              ...
              value: function(e) {
                var t = e.userId,
                  r = e.teamId,
                  a = e.teamMemberId,
                  p = u(e, ['userId', 'teamId', 'teamMemberId'])
                return this.axiosConfiguration
                  .get(
                    'users/'
                      .concat(t, '/teams/')
            ...
            },
            {
              ...
              value: function(e) {
                var t = e.userId,
                  ...
                  a = u(e, ['userId', 'range'])
                return this.axiosConfiguration
                  .get('users/'.concat(t, '/stats/').concat(f[r]), { params: c(a) })
                  .then(function(e) {
                    return e.data
                  })
              }
            ...
            },
            {
              ...
              value: function() {
                var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                  ...
                  p = void 0 === a ? null : a
                return this.axiosConfiguration
                  .get('leaders', { params: { language: r, page: p } })
                  .then(function(e) {
                    return e.data
                  })
              }
            ...
            },
            {
              ...
              value: function(e) {
                var t = e.userId,
                  r = e.projectName,
                  a = u(e, ['userId', 'projectName'])
                return this.axiosConfiguration
                  .get('users/'.concat(t, '/projects/').concat(r, '/commits'), { params: h(a) })
                  .then(function(e) {
                    return e.data
                  })
              }
  ...
  883: function(e, t, r) {
    ...
    const d = e => {
      ...
      if ((!e || e === a.release()) && ['6.1', '6.2', '6.3', '10.0'].includes(r)) {
        let e
        try {
          e = p.sync('wmic', ['os', 'get', 'Caption']).stdout || ''
        } catch (t) {
          e =
            p.sync('powershell', ['(Get-CimInstance -ClassName Win32_OperatingSystem).caption'])
              .stdout || ''
        }
  ...
  889: function(e, t, r) {
    ...
    function spawn(e, t, r) {
      const d = p(e, t, r)
      const s = a.spawn(d.command, d.args, d.options)
      i.hookChildProcess(s, d)
      return s
    }
    function spawnSync(e, t, r) {
      const d = p(e, t, r)
      const s = a.spawnSync(d.command, d.args, d.options)
  ...
  909: function(e, t, r) {
    ...
    function mergeDeep(e, t) {
      ...
      Object.keys(t).forEach(p => {
        if (a.isPlainObject(t[p])) {
          if (!(p in e)) Object.assign(r, { [p]: t[p] })
          else r[p] = mergeDeep(e[p], t[p])
        } else {
          Object.assign(r, { [p]: t[p] })
        }
      })
      return r
    }
    ...
    function getValues(e, t, r, a) {
      ...
      if (isDefined(p) && p !== '') {
        if (typeof p === 'string' || typeof p === 'number' || typeof p === 'boolean') {
          p = p.toString()
          if (a && a !== '*') {
            p = p.substring(0, parseInt(a, 10))
          }
          i.push(encodeValue(t, p, isKeyOperator(t) ? r : ''))
        } else {
          if (a === '*') {
            if (Array.isArray(p)) {
              p.filter(isDefined).forEach(function(e) {
                i.push(encodeValue(t, e, isKeyOperator(t) ? r : ''))
              })
            } else {
              Object.keys(p).forEach(function(e) {
                if (isDefined(p[e])) {
                  i.push(encodeValue(t, p[e], e))
                }
              })
            }
          } else {
            const e = []
            if (Array.isArray(p)) {
              p.filter(isDefined).forEach(function(r) {
              ...
              Object.keys(p).forEach(function(r) {
                if (isDefined(p[r])) {
                  ...
                  e.push(encodeValue(t, p[r].toString()))
                }
              })
            }
            if (isKeyOperator(t)) {
    ...
    function expand(e, t) {
      var r = ['+', '#', '.', '/', ';', '?', '&']
      return e.replace(/\{([^\{\}]+)\}|([^\{\}]+)/g, function(e, a, p) {
        if (a) {
          let e = ''
          const p = []
          ...
          a.split(/,/g).forEach(function(r) {
            var a = /([^:\*]*)(?::(\d+)|(\*))?/.exec(r)
            p.push(getValues(t, e, a[1], a[2] || a[3]))
          })
          if (e && e !== '+') {
            var i = ','
            if (e === '?') {
    ...
    function parse(e) {
      ...
      const s = Object.keys(e)
        ...
        .concat('baseUrl')
      const n = omit(i, s)
      const o = /application\/octet-stream/i.test(a.accept)
      if (!o) {
      ...
      if (!a['content-type'] && typeof p !== 'undefined') {
      ...
      return Object.assign(
        ...
        typeof p !== 'undefined' ? { body: p } : null,
    ...
    const d = '6.0.12'
    const s = `octokit-endpoint.js/${d} ${p.getUserAgent()}`
    const n = {
      method: 'GET',
  ...
  945: function(e, t, r) {
    ...
    e.exports = function(e) {
      ...
      var p = r[0].split('/').pop()
      var i = r[1]
      return p === 'env' ? i : p + (i ? ' ' + i : '')
    }
  },
  950: function(e, t, r) {
    e.exports = Octokit
    const { request: a } = r(246)
    const p = r(128)
    const i = r(522)
    function Octokit(e, t) {
      t = t || {}
      const r = new p.Collection()
      const d = Object.assign(
        { debug: () => {}, info: () => {}, warn: console.warn, error: console.error },
        t && t.log
      )
      const s = { hook: r, log: d, request: a.defaults(i(t, d, r)) }
      e.forEach(e => e(s, t))
      return s
    }
  },
  ...
  963: function(e, t, r) {
    ...
    const u = /\.(?:com|exe)$/i
    const m = /node_modules[\\/].bin[\\/][^\\/]+\.cmd$/i
    const l = p(() => n.satisfies(process.version, '^4.8.0 || ^5.7.0 || >= 6.0.0', true)) || false
  ...
  964: function(e, t, r) {
    ...
    function registerEndpoints(e, t) {
      Object.keys(t).forEach(r => {
        ...
        Object.keys(t[r]).forEach(p => {
          ...
          const n = Object.keys(i.params || {}).find(e => i.params[e].deprecated)
          if (n) {
            const t = patchForDeprecation.bind(null, e, i)
            s = t(e.request.defaults(d), `.${r}.${p}()`)
            s.endpoint = t(s.endpoint, `.${r}.${p}.endpoint()`)
            s.endpoint.merge = t(s.endpoint.merge, `.${r}.${p}.endpoint.merge()`)
          }
          if (i.deprecated) {
            e[r][p] = Object.assign(function deprecatedEndpointMethod() {
    ...
    function patchForDeprecation(e, t, r, p) {
      const i = i => {
        i = Object.assign({}, i)
        Object.keys(i).forEach(r => {
          if (t.params[r] && t.params[r].deprecated) {
            ...
            e.log.warn(
              new a.Deprecation(
                `[@octokit/rest] "${r}" parameter is deprecated for "${p}". Use "${d}" instead`
              )
            )
            if (!(d in i)) {
              i[d] = i[r]
    ...
    e.exports = a.isStandardBrowserEnv()
      ? (function standardBrowserEnv() {
          ...
          return function isURLSameOrigin(e) {
            var t = a.isString(e) ? resolveURL(e) : e
  ...
  995: function(e, t, r) {
    ...
    var a = _interopDefault(r(794))
    var p = _interopDefault(r(605))
    var i = _interopDefault(r(835))
    var d = _interopDefault(r(875))
    var s = _interopDefault(r(211))
    var n = _interopDefault(r(761))
    const o = a.Readable
    ...
    class Blob {
      constructor() {
        ...
        if (e) {
          ...
          for (let e = 0; e < p; e++) {
            ...
            if (p instanceof Buffer) {
              ...
              i = Buffer.from(p.buffer, p.byteOffset, p.byteLength)
            } else if (p instanceof ArrayBuffer) {
              i = Buffer.from(p)
            } else if (p instanceof Blob) {
              i = p[u]
            } else {
              i = Buffer.from(typeof p === 'string' ? p : String(p))
            }
            a += i.length
            r.push(i)
          }
        ...
        let p = t && t.type !== undefined && String(t.type).toLowerCase()
        if (p && !/[^\u0020-\u007E]/.test(p)) {
          this[m] = p
        }
      }
      ...
      slice() {
        ...
        const i = Math.max(p - a, 0)
        const d = this[u]
        const s = d.slice(a, a + i)
    ...
    function consumeBody() {
      ...
      let p = 0
      let i = false
      return new Body.Promise(function(a, d) {
        let s
        if (e.timeout) {
        ...
        t.on('data', function(t) {
          ...
          if (e.size && p + t.length > e.size) {
            i = true
            d(new FetchError(`content size at ${e.url} over limit: ${e.size}`, 'max-size'))
            return
          }
          p += t.length
          r.push(t)
    ...
    function convertBody(e, t) {
      ...
      if (!p && i) {
        p = /<meta.+?charset=(['"])(.+?)\1/i.exec(i)
      }
      if (!p && i) {
        p = /<meta[\s]+?http-equiv=(['"])content-type\1[\s]+?content=(['"])(.+?)\2/i.exec(i)
        if (!p) {
          p = /<meta[\s]+?content=(['"])(.+?)\1[\s]+?http-equiv=(['"])content-type\3/i.exec(i)
          if (p) {
            p.pop()
          }
        }
    ...
    function clone(e) {
      ...
      if (p instanceof a && typeof p.getBoundary !== 'function') {
        t = new g()
        r = new g()
        p.pipe(t)
        p.pipe(r)
    ...
    const w = Object.setPrototypeOf(
      {
        next() {
          ...
          const t = e.target,
            r = e.kind,
            a = e.index
          const p = getHeaders(t, r)
          const i = p.length
          if (a >= i) {
            return { value: undefined, done: true }
          }
          this[v].index = a + 1
          return { value: p[a], done: false }
        }
      },
    ...
    class Request {
      constructor(e) {
        ...
        let p = t.body != null ? t.body : isRequest(e) && e.body !== null ? clone(e) : null
        Body.call(this, p, { timeout: t.timeout || e.timeout || 0, size: t.size || e.size || 0 })
        const i = new Headers(t.headers || e.headers || {})
        if (p != null && !i.has('Content-Type')) {
          const e = extractContentType(p)
          if (e) {
    ...
    const k = i.URL || d.URL
    const N = a.PassThrough
    const C = function isDomainOrSubdomain(e, t) {
    ...
    function fetch(e, t) {
      ...
      return new fetch.Promise(function(r, i) {
        ...
        const u = (o.protocol === 'https:' ? s : p).request
        const m = d.signal
        let l = null
        const c = function abort() {
          let e = new AbortError('The user aborted a request.')
          i(e)
          if (d.body && d.body instanceof a.Readable) {
            d.body.destroy(e)
          }
          if (!l || !l.body) return
          l.body.emit('error', e)
        ...
        function finalize() {
          h.abort()
          if (m) m.removeEventListener('abort', g)
          clearTimeout(f)
        }
        if (d.timeout) {
          h.once('socket', function(e) {
            f = setTimeout(function() {
              i(new FetchError(`network timeout at: ${d.url}`, 'request-timeout'))
              finalize()
            }, d.timeout)
          })
        }
        h.on('error', function(e) {
          i(new FetchError(`request to ${d.url} failed, reason: ${e.message}`, 'system', e))
          finalize()
        })
        h.on('response', function(e) {
          ...
          if (fetch.isRedirect(e.statusCode)) {
            ...
            let p = null
            try {
              p = a === null ? null : new k(a, d.url).toString()
            } catch (e) {
            ...
            switch (d.redirect) {
              ...
              case 'follow':
                ...
                if (d.counter >= d.follow) {
                  i(new FetchError(`maximum redirect reached at: ${d.url}`, 'max-redirect'))
                  finalize()
                  return
                }
                const a = {
                ...
                if (e.statusCode !== 303 && d.body && getTotalBytes(d) === null) {
                  i(
                    new FetchError(
                ...
                if (
                  e.statusCode === 303 ||
                  ((e.statusCode === 301 || e.statusCode === 302) && d.method === 'POST')
                ) {
                  a.method = 'GET'
                  a.body = undefined
                  a.headers.delete('content-length')
                }
                r(fetch(new Request(p, a)))
                finalize()
                return
            }
          }
